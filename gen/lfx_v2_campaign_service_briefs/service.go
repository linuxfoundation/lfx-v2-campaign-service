...
// MethodKey key.
var MethodNames = [11]string{"create-brief", "get-brief", "update-brief", "approve-brief", "delete-brief", "create-campaigns", "get-campaign", "update-campaign", "toggle-campaign-status", "delete-campaign", "get-job"}
