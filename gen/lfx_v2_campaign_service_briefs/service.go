...
type Service interface {
	...
	// / the brief lost approval during the read, and 400 when the platform has no
	// adoption capability wired. An adopted campaign supports metrics, delete and
	// pause; activation is refused, because adoption does not verify the targeting
	// the activate guard requires.
...
// MethodKey key.
var MethodNames = [15]string{"create-brief", "find-brief", "get-brief", "update-brief", "approve-brief", "delete-brief", "fetch-event-url", "create-campaigns", "adopt-campaign", "get-campaign", "get-campaign-metrics", "update-campaign", "toggle-campaign-status", "delete-campaign", "get-job"}
