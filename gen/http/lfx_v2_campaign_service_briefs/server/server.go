...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			...
			{"ListCampaigns", "GET", "/projects/{project_id}/briefs/{brief_id}/campaigns"},
		...
		ListCampaigns:        NewListCampaignsHandler(e.ListCampaigns, mux, decoder, encoder, errhandler, formatter),
...
func (s *Server) Use(m func(http.Handler) http.Handler) {
	...
	s.ListCampaigns = m(s.ListCampaigns)
...
func Mount(mux goahttp.Muxer, h *Server) {
	...
	MountListCampaignsHandler(mux, h.ListCampaigns)
...
// MountListCampaignsHandler configures the mux to serve the
// "lfx-v2-campaign-service-briefs" service "list-campaigns" endpoint.
func MountListCampaignsHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("GET", "/projects/{project_id}/briefs/{brief_id}/campaigns", f)
}

// NewListCampaignsHandler creates a HTTP handler which loads the HTTP request
// and calls the "lfx-v2-campaign-service-briefs" service "list-campaigns"
// endpoint.
func NewListCampaignsHandler(
	...
	var (
		decodeRequest  = DecodeListCampaignsRequest(mux, decoder)
		encodeResponse = EncodeListCampaignsResponse(encoder)
		encodeError    = EncodeListCampaignsError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "list-campaigns")
		ctx = context.WithValue(ctx, goa.ServiceKey, "lfx-v2-campaign-service-briefs")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
