...
type Service interface {
	...
	// UNSPECIFIED (creation). **Do not read the first row as the best match** —
	// the search is token-based, so a hit can merely share a token with the query.
	// Every match is returned, in the order HubSpot returned them, rather than
