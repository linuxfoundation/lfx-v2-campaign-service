...
type Service interface {
	...
	// The match is HubSpot's own full-text search: fuzzy and scored, NOT an
	// exact-name lookup, so a hit can merely share a token with the query. Every
	// match is returned in HubSpot's relevance order rather than narrowed to a
