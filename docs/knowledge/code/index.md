...
* [internal/platform/hubspot](internal-platform-hubspot.md) - HubSpot API client (email-channel scaffold): static private-app bearer auth, request layer with 429 retry, typed body-free errors.
