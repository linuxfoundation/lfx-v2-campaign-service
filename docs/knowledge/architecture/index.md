...
* [Local pre-PR review](local-pre-pr-review.md) - How the short pre-PR review block in CLAUDE.md points at the central /lfx-skills:lfx-pre-pr-review skill and names the two repo-owned values it reads: the knowledge-base review skill and the deterministic preflight.
