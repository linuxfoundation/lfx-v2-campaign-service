...
PR #60 have both since merged into `main`, claiming `000008`/`000009` and `000010`/`000011`
respectively — this branch's reserved `000012`/`000013` headroom is no longer the next free
version; `000010`/`000011` now is. Cleared the now-stale `allowedVersionGaps` entry (`8: "PR #59
… and PR #60 … must merge before this branch"`) since both predecessors are merged and there is
no remaining gap for the test to tolerate.
