...
| GET | `/projects/{projectId}/briefs?event_slug=` | `campaign_manager` | JSON | Find the saved brief for an event slug; returns ETag. `404` when the event has no brief yet (the ordinary first-generation case). See the D5 note below. |
