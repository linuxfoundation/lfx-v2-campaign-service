...
- Subreddit targeting uses subreddit IDs, not names; supplied names are resolved to IDs via the Ads API v3 subreddit lookup (`GET /subreddits?query=<name>`) before the ad-group create
